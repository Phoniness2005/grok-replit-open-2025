...
- Site hub (v2 on top, v1 underneath): https://dabbuilds.com/play/
...
| Folder | What it is |
|---|---|
| `v2/` | Clickable menus, mouse or W/S, three actually-different opponents, court graphics that sit inside the collision lines. |
| `v1/` | The original Grok/Replit build, kept so you can see the evolution. |

## Version 2 in short

- Menus are HTML. Click them, or use arrows and Enter. Holding a key no longer skips the list.
- Score and instructions sit on the court, not the page around the iframe.
